...
@section('page_title', 'Create Chapter')
@section('page_description', 'Add a new chapter to: ' . $book->title)
...
@section('form')
    ...
    @include('admin.beginner.books.partials-chapter-form', ['mode' => 'create'])
@endsection
